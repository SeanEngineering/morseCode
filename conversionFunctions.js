    ...
    if (item.includes("\n")) {
      ...
      for (let properties of temp) {
        ...
        if (properties == "|" || properties == "/"){
          englishArray.push(" ");
        } else if (Object.keys(morseLibrary).find((key) => morseLibrary[key] === properties) == undefined){
          return `(${properties} is not in defined in this library)`;
        } else {
          englishArray.push(
            Object.keys(morseLibrary).find((key) => morseLibrary[key] === properties)
          );
        }
      ...
      if (item == "|" || item == "/") {
        englishArray.push(" ");
      } else if (Object.keys(morseLibrary).find((key) => morseLibrary[key] === item) == undefined){
